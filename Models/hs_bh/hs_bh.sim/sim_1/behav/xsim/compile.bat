...
REM
REM Generated by Vivado on Sun May 31 01:56:23 +0530 2026
...
echo "xvhdl --incr --relax -prj hs_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj hs_bh_tbw_vhdl.prj -log xvhdl.log
