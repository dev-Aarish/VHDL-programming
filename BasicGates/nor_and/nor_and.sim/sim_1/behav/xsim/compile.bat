...
REM
REM Generated by Vivado on Sun May 31 15:11:17 +0530 2026
...
echo "xvhdl --incr --relax -prj nor_and_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj nor_and_tbw_vhdl.prj -log xvhdl.log
