...
REM
REM Generated by Vivado on Sun May 31 15:25:48 +0530 2026
...
echo "xvhdl --incr --relax -prj nor_xor_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj nor_xor_tbw_vhdl.prj -log xvhdl.log
