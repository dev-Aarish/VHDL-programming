...
REM
REM Generated by Vivado on Sun May 31 12:55:10 +0530 2026
...
echo "xvhdl --incr --relax -prj ha_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj ha_bh_tbw_vhdl.prj -log xvhdl.log
