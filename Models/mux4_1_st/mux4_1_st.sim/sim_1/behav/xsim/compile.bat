...
REM
REM Generated by Vivado on Sun May 31 14:34:43 +0530 2026
...
echo "xvhdl --incr --relax -prj mux4_1_st_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj mux4_1_st_tbw_vhdl.prj -log xvhdl.log
