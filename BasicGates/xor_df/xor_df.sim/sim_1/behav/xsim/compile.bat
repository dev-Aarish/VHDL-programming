...
REM
REM Generated by Vivado on Sun May 31 14:53:31 +0530 2026
...
echo "xvhdl --incr --relax -prj xor_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj xor_df_tbw_vhdl.prj -log xvhdl.log
