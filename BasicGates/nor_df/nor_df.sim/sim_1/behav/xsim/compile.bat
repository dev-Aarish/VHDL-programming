...
REM
REM Generated by Vivado on Sun May 31 00:07:42 +0530 2026
...
echo "xvhdl --incr --relax -prj nor_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj nor_df_tbw_vhdl.prj -log xvhdl.log
