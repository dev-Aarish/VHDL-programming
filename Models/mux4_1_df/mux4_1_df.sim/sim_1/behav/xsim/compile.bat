...
REM
REM Generated by Vivado on Sun May 31 13:59:36 +0530 2026
...
echo "xvhdl --incr --relax -prj mux4_1_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj mux4_1_df_tbw_vhdl.prj -log xvhdl.log
