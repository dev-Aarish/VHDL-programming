...
REM
REM Generated by Vivado on Sun May 31 10:25:56 +0530 2026
...
echo "xvhdl --incr --relax -prj fa_st_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj fa_st_tbw_vhdl.prj -log xvhdl.log
