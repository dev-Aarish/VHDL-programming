...
REM
REM Generated by Vivado on Sun May 31 15:56:53 +0530 2026
...
echo "xvhdl --incr --relax -prj decoder3_8_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj decoder3_8_df_tbw_vhdl.prj -log xvhdl.log
