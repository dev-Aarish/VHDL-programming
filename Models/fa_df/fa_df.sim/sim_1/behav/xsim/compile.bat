...
REM
REM Generated by Vivado on Sun May 31 01:37:55 +0530 2026
...
echo "xvhdl --incr --relax -prj fa_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj fa_df_tbw_vhdl.prj -log xvhdl.log
