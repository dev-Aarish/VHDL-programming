...
REM
REM Generated by Vivado on Sun May 31 15:32:48 +0530 2026
...
echo "xvhdl --incr --relax -prj nand_xor_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj nand_xor_tbw_vhdl.prj -log xvhdl.log
