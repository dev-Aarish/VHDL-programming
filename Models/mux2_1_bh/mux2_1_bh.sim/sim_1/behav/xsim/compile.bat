...
REM
REM Generated by Vivado on Sun May 31 14:09:18 +0530 2026
...
echo "xvhdl --incr --relax -prj mux2_1_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj mux2_1_bh_tbw_vhdl.prj -log xvhdl.log
