...
REM
REM Generated by Vivado on Sun May 31 12:22:39 +0530 2026
...
echo "xvhdl --incr --relax -prj decoder3_8_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj decoder3_8_bh_tbw_vhdl.prj -log xvhdl.log
