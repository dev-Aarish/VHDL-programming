...
REM
REM Generated by Vivado on Sun May 31 09:10:22 +0530 2026
...
echo "xvhdl --incr --relax -prj mux4_1_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj mux4_1_tbw_vhdl.prj -log xvhdl.log
