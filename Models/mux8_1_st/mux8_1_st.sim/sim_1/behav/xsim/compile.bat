...
REM
REM Generated by Vivado on Sun May 31 09:44:02 +0530 2026
...
echo "xvhdl --incr --relax -prj mux8_1_st_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj mux8_1_st_tbw_vhdl.prj -log xvhdl.log
