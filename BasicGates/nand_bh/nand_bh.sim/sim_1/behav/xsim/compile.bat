...
REM
REM Generated by Vivado on Sun May 31 00:18:33 +0530 2026
...
echo "xvhdl --incr --relax -prj nand_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj nand_bh_tbw_vhdl.prj -log xvhdl.log
