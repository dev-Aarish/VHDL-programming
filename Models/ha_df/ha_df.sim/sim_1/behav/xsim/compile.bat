...
REM
REM Generated by Vivado on Sun May 31 10:09:46 +0530 2026
...
echo "xvhdl --incr --relax -prj ha_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj ha_df_tbw_vhdl.prj -log xvhdl.log
